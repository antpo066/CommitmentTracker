        ...
        <div className="flex items-center gap-3 sm:gap-4">
          ...
          <div className="min-w-0 flex-1">
            ...
            <div className="flex flex-wrap items-baseline gap-x-2 gap-y-0.5">
              ...
              {person.handle && (
                <span className="text-xs text-stone-400">{person.handle}</span>
              )}
              <span className="text-xs text-stone-400">·</span>
              <span className="text-xs text-stone-500">{person.descriptor}</span>
            </div>
            ...
            <div className="mt-1 flex flex-wrap gap-x-4 gap-y-1 text-[11px] text-stone-400">
              ...
              <span className="flex items-center gap-1">
                ...
                {formatDate(person.coverageDates.from)} – {formatDate(person.coverageDates.to)}
              </span>
              <span className="flex items-center gap-1">
